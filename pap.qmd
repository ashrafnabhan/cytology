...
Results: A total of 95120 samples were found to be satisfactory and were included in the analysis. The mean age of included women was 38.5 (10.5). Abnormal epithelial cells were reported in 5174 of the samples (`r abcy`). The most frequent epithelial cell abnormalities were low grade squamous intraepithelial lesion in 4144 women (`r LGSIL`), followed by atypical squamous cells in 378 women (`r ASC`), high grade squamous intraepithelial lesion in 226 women (`r HGSIL`), and squamous cell carcinoma in 70 women (`r scc`). There were 184 (`r ag`) atypical glandular NOS (not otherwise specified) and 165 (`r ac`) adenocarcinoma observations. The yearly number of screened women was positively associated with the observed LGSIL (correlation coefficient \[95%CI\] = `r lgestimate` \[`r lgci`\]), not significantly associated with HGSIL (correlation coefficient \[95%CI\] = `r hgestimate` \[`r hgci`\]), and negatively associated with the observed suspected invasion (correlation coefficient \[95%CI\] = `r malestimate` \[`r malci`\]).
...
Condyloma rate fluctuated from 4% to 1% and rate of CIN started with 9% in 1981 and ended by 0.52% in 2004. Detection of LGSIL declined from 6.9% in 1981 to 4.3% in 2022, while HGSIL declined from 1.2% to 0.13%. The estimated rate of premalignant lesions (ASC, LGSIL & HGSIL) showed fluctuation over the 42 years. The rate started with about 10% in 1981 and ended by 5% in 2022. The temporal trends are depicted in @fig-sil and @fig-malig.
...
![Yearly screened women and suspected invasive lesions](fig/pmal.png){#fig-mal}
